...
export default function BuyButton({
  ...
  return (
    <Link href={paymentLink} prefetch={false}>
      <button
        className={cn(
          'group relative inline-block cursor-pointer rounded-xl bg-[#B4EA51] p-px text-xs font-semibold leading-6 text-white no-underline shadow-2xl shadow-zinc-900 transition-transform duration-300 hover:scale-105',
          className
        )}
      >
        ...
        <div className='relative flex h-14 w-full items-center justify-center gap-2 rounded-xl bg-background px-4 py-0.5 ring-1 ring-white/10 transition-colors duration-300 hover:bg-background/20'>
